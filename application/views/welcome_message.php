...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="https://nicholasdw.com" target="_blank">Nicholas</a></li>
			<li class="menu-item hidden"><a href="#">Home</a></li>
			<li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Docs</a></li>
			<li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Community</a></li>
			<li class="menu-item hidden"><a href="https://github.com/lauslim12/ignite-grocerycrud" target="_blank">Contribute</a></li>
		</ul>
	</div>

	<div class="heroe">

		<h1>Welcome to CodeIgniter x GroceryCRUD!</h1>

		<h2>The small framework with powerful features. Quick prototyping by Nicholas Dwiarto.</h2>

		<h2>You can see the GroceryCRUD by clicking links below:</h2>
		<li class='menu-item'>
			<a href='<?php echo site_url('dealership/employees')?>'>Simplified</a>
		</li>
		<li class='menu-item'>
			<a href='<?php echo site_url('dealership/vehicles')?>'>Detailed</a>
		</li>
		<li class='menu-item'>
			<a href='<?php echo site_url('dealership/relational')?>'>Relationships</a>
		</li>
		<li class='menu-item'>
			<a href='<?php echo site_url('dealership/validation')?>'>Validations</a>
		</li>
		<li class='menu-item'>
			<a href='<?php echo site_url('dealership/callback')?>'>Callback</a>
		</li>
		<li class="menu-item">
			<a href='<?php echo site_url('dealership/file_upload')?>'>File Uploads</a>
		</li>

		<p>Hosted with <i class="em em-heart" aria-role="presentation" aria-label="HEAVY BLACK HEART"></i> at <code class='special'>nicholasdw.com</code> by Nicholas Dwiarto.</p>
	</div>
...
<section>
	...
	<p>The page you are looking at is being generated dynamically by CodeIgniter but customized by Nicholas.</p>

	<p>If you would like to edit this (current) page you will find it located at:</p>
	...
	<pre><code>application/views/table_display.php</code></pre>
